...
let HomeComponent = class HomeComponent {
    ...
    constructor(_http, _data, _path) {
        this._http = _http;
        this._data = _data;
        this._path = _path;
        this.subscription = this._data.data.subscribe((newValue) => { this.data = newValue; });
    }
    ngOnInit() {
        this._data.httpGet();
    }
...
let SingleNewsComponent = class SingleNewsComponent {
    constructor(_path, _data) {
        ...
        this._data.httpGet();
        this.subscription = this._data.data.subscribe((objResult) => {
...
SingleNewsComponent.ctorParameters = () => [
